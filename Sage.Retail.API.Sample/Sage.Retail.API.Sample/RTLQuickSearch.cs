...
namespace Sage.Retail.API.Sample {
    public class RTLQuickSearch {
        ...
        public static QuickSearch CreateQuickSearch(EntityTypeEnum entityType) {
            var systemSettings = RTLAPIEngine.SystemGlobals.SystemSettings;
            ...
            quickSearch = RTLAPIEngine.SystemGlobals.CreateQuickSearch(qsvQuickSearchID, false);

            if (paramValues != null)
                quickSearch.Parameters = paramValues;

            return quickSearch;
            //rtlQuickSearch.quickSearch.SelectValue();
        }
        #endregion
    }
}